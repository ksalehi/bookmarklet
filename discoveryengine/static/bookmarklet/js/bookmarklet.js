...
function DE_BOOKMARKLET_showPopupMessage(doi) {
  let template = ' \
    <div id="deBookmarkletPopupBlocker" style="position: absolute; top: 0; right: 0; left: 0; background: #FF3366; color: white; text-align: center; padding: 10px; z-index: 1001; display: flex; flex-direction: horizontal; align-items: center; justify-content: center;"> \
